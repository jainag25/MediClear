export default function GlossaryPanel({
  ...
  return (
    <aside className="h-fit rounded-2xl bg-white p-4 ring-1 ring-gray-100">
      <div className="mb-3 flex items-center justify-between">
        <h3 className="text-sm font-bold text-gray-900">Saved Glossary</h3>
        {glossary.length > 0 && (
          <button
            type="button"
      ...
      {glossary.length === 0 ? (
        ...
        <div className="space-y-2">
          {glossary.map((entry) => (
            <div
              key={entry.term}
              className="rounded-xl border border-gray-100 p-3 transition-all duration-300"
            ...
            >
              <div className="flex items-start justify-between gap-2">
                ...
                >
                  <p className="truncate text-sm font-bold text-gray-900">{entry.term}</p>
